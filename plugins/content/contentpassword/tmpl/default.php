...
<div class="contentpassword">
	...
	<!--<?php echo $this->description; ?>-->This post is password protected. To view it please enter your password below:
	<?php if ($this->error): ?>
	...
	<form class="contentpassword-form" name="contentpassword_form" method="post" action="<?php echo $this->action ?>">
		...
		<input type="submit" class="contentpassword-submit" name="contentpassword_submit" value="Submit" />
	</form>
</div>