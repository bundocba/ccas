...
class com_rseventsproInstallerScript 
{
	...
	public function installprocess($type) {
		...
		if ($type == 'update') {
			...
			// Run queries
			$sqlfile = JPATH_ADMINISTRATOR.'/components/com_rseventspro/install.mysql.utf8.sql';
...
<div id="installer-right">
	...
	<ul class="version-history">
		...
		<li><span class="version-upgraded">Upg</span> Inproved event filtering in backend.</li>
		<li><span class="version-new">New</span> Added new permissions: Can approve events and Can approve tags.</li>
		<li><span class="version-new">New</span>  Error handling option.</li>
		<li><span class="version-new">New</span>  K2 avatar integration.</li>
		<li><span class="version-new">New</span>  QR code integration. (Option available with the PDF plugin.)</li>
		<li><span class="version-new">New</span>  Notify owner when user unsubscribes.</li>
		<li><span class="version-new">New</span>  Use com_categories as the default category listing.</li>
	</ul>
