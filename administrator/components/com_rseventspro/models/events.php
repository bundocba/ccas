...
class rseventsproModelEvents extends JModelLegacy
{
	...
	public function getOtherFilters() {
		...
		if ($this->_input->getInt('rs_clear',0)) {
			...
			return array('archived' => null, 'childs' => null, 'start' => null, 'end' => null);
		}
		...
		return array('archived' => $archived, 'childs' => $childs, 'start' => $start, 'end' => $end);
	}
	...
	public function getFilterOptions() { 
		return array(JHTML::_('select.option', 'events', JText::_('COM_RSEVENTSPRO_FILTER_NAME')), JHTML::_('select.option', 'description', JText::_('COM_RSEVENTSPRO_FILTER_DESCRIPTION')), 
			...
			JHTML::_('select.option', 'tags', JText::_('COM_RSEVENTSPRO_FILTER_TAG')), JHTML::_('select.option', 'archived', JText::_('COM_RSEVENTSPRO_FILTER_ARCHIVED')),
			JHTML::_('select.option', 'child', JText::_('COM_RSEVENTSPRO_FILTER_CHILD')), JHTML::_('select.option', 'start', JText::_('COM_RSEVENTSPRO_FILTER_FROM')),
			JHTML::_('select.option', 'end', JText::_('COM_RSEVENTSPRO_FILTER_TO'))
		);
	}
