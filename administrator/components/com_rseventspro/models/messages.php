...
class rseventsproModelMessages extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true) {
		...
		// Get the form.
		$form = $this->loadForm('com_rseventspro.messages', 'messages', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
			return false;
	...
	public function getTypes() {
		return array('registration','activation','unsubscribe','denied','invite','reminder','preminder','moderation','tag_moderation','notify_me');
	}
