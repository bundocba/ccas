...
function rs_add_filter() {
	...
	if ($('search').value != '' || $('filter_from').value == 'archived'  || $('filter_from').value == 'child' || $('filter_from').value == 'start' || $('filter_from').value == 'end')
		document.adminForm.submit();
}
		...
		<div class="span10">
			...
			<table class="table table-striped adminlist">
				<thead>
					...
					<th width="10%" class="nowrap hidden-phone"><?php echo JText::_('COM_RSEVENTSPRO_TH_LOCATION'); ?></th>
					<th width="10%" class="nowrap hidden-phone"><?php echo JText::_('COM_RSEVENTSPRO_TH_OWNER'); ?></th>
					<th width="10%" class="nowrap hidden-phone"><?php echo JText::_('COM_RSEVENTSPRO_TH_CATEGORIES'); ?></th>
					<th width="10%" class="nowrap hidden-phone"><?php echo JText::_('COM_RSEVENTSPRO_TH_TAGS'); ?></th>
					<th width="10%" class="nowrap hidden-phone"><?php echo JText::_('COM_RSEVENTSPRO_TH_ENDING'); ?></th>
					<th width="5%" class="nowrap hidden-phone"><?php echo JText::_('JSTATUS'); ?></th>
				...
				<tbody id="rseprocontainer_ongoing">
					...
					<tr class="<?php echo 'row'.$k.$complete; ?>">
						<td align="center" class="center hidden-phone"><?php echo JHTML::_('grid.id',$i,$row->id); ?></td>
						...
						<td class="nowrap has-context">
							...
							<div class="rs_event_details">
								...
								<p><?php echo $this->getTickets($row->id); ?></p>
							</div>
							<?php if ($row->parent) { ?>
							<div class="rs_child">
						...
						<td align="center" class="center hidden-phone"><?php echo JHTML::_('jgrid.published', $row->published, $i, 'events.'); ?></td>
