...
<ul class="rs_events_container" id="rs_events_container">
	...
	<li class="rs_event_detail<?php echo $incomplete; ?>" id="rs_event<?php echo $event->id; ?>" itemscope itemtype="http://schema.org/Event">
...
<script type="text/javascript">
	window.addEvent('domready', function(){
		...
		$('rsepro_loadmore').addEvent('click', function(el) {
			var lstart = $('rs_events_container').getElements('li');
			rspagination('day',lstart.length);
		});
		<?php } ?>
