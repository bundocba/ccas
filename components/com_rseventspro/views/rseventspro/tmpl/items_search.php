...
<li class="rs_event_detail<?php echo $incomplete; ?>" id="rs_event<?php echo $event->id; ?>">
	
	<div class="rs_options" style="display:none;">
		<?php if ((!empty($this->permissions['can_edit_events']) || $event->owner == $this->user || $this->admin) && !empty($this->user)) { ?>
		...
		<?php } ?>
		<?php if ((!empty($this->permissions['can_delete_events']) || $event->owner == $this->user || $this->admin) && !empty($this->user)) { ?>
	...
	<div class="rs_event_details">
		...
		<span>
			...
			<?php } else { ?>
			<?php echo JText::_('COM_RSEVENTSPRO_GLOBAL_FROM'); ?> <b><?php echo rseventsproHelper::date($event->start,null,true); ?></b> <?php echo JText::_('COM_RSEVENTSPRO_GLOBAL_TO_LOWERCASE'); ?> <b><?php echo rseventsproHelper::date($event->end,null,true); ?></b>
			<?php } ?>
		</span>
		<span>
