...
<script type="text/javascript">
	<?php if (rseventsproHelper::getConfig('multi_tickets','int') && $this->event->max_tickets) { ?>var maxtickets = parseInt(<?php echo $this->event->max_tickets_amount; ?>);<?php echo "\n"; } ?>
...
<?php if (rseventsproHelper::getConfig('modal','int') == 1 || rseventsproHelper::getConfig('modal','int') == 2 ) { ?>
<style type="text/css">
...
<div class="rs_subscribe">
	...
	<?php if (!empty($this->tickets) && !$this->thankyou) { ?><script type="text/javascript">rs_get_ticket($('RSEProTickets').value);</script><?php } ?>
</div>
<?php } else { ?>
...
<div class="rs_subscribe">
	...
	<p>
		...
		<input type="text" name="coupon" id="coupon" value="" size="40" class="rs_edit_inp_small" onkeyup="rse_calculatetotal();" />
...
<?php if (!empty($this->tickets)) { ?><script type="text/javascript">rs_get_ticket($('ticket').value);</script><?php } ?>
<?php } ?>
