...
<!-- Event Title -->
<h1 class="<?php echo $full ? ' rs_event_full' : ''; ?><?php echo $ongoing ? ' rs_event_ongoing' : ''; ?>" itemprop="name"><?php echo $this->escape($event->name); ?></h1>
<!--//end Event Title -->
...
<!-- Invite/Join/Unsubscribe -->	
	...
	<?php } else { ?>
	<?php $Uclass = $links == 0 || $links == 2 ? 'modal' : ''; ?>
...
<p class="rs_image" itemprop="image">
	<a href="<?php echo $details['image']; ?>" class="modal">
...
<?php } else { ?>
	...
	<p class="rsep_date">
		<?php echo JText::_('COM_RSEVENTSPRO_EVENT_FROM'); ?> <?php echo rseventsproHelper::date($event->start,null,true); ?> <?php echo JText::_('COM_RSEVENTSPRO_EVENT_UNTIL'); ?> <?php echo rseventsproHelper::date($event->end,null,true); ?> 
		<?php if (!empty($this->options['show_export'])) { ?>
		<a href="<?php echo rseventsproHelper::route('index.php?option=com_rseventspro&task=rseventspro.export&id='.rseventsproHelper::sef($event->id,$event->name)); ?>">
			<span class="rsep_export"><?php echo JText::_('COM_RSEVENTSPRO_EXPORT_EVENT'); ?></span>
		</a> 
	...
	<p class="rsep_date">
		<?php echo JText::_('COM_RSEVENTSPRO_EVENT_STARTING_ON'); ?> <?php echo rseventsproHelper::date($event->start,null,true); ?> 
		<?php if (!empty($this->options['show_export'])) { ?>
		<a href="<?php echo rseventsproHelper::route('index.php?option=com_rseventspro&task=rseventspro.export&id='.rseventsproHelper::sef($event->id,$event->name)); ?>">
			<span class="rsep_export"><?php echo JText::_('COM_RSEVENTSPRO_EXPORT_EVENT'); ?></span>
		</a> 
	...
	<p class="rsep_date">
		<?php echo JText::_('COM_RSEVENTSPRO_EVENT_ENDING_ON'); ?> <?php echo rseventsproHelper::date($event->end,null,true); ?>
		<?php if (!empty($this->options['show_export'])) { ?>
		<a href="<?php echo rseventsproHelper::route('index.php?option=com_rseventspro&task=rseventspro.export&id='.rseventsproHelper::sef($event->id,$event->name)); ?>">
			<span class="rsep_export"><?php echo JText::_('COM_RSEVENTSPRO_EXPORT_EVENT'); ?></span>
		</a> 
